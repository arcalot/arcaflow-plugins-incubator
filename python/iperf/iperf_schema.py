...
type_descriptions = """The flowop name for iperf.\n""" \
...
class ProfileFlowOpCommon:
    ...
    rate: typing.Optional[int] = field(
        ...
        metadata={
            "name": "rate",
            "description": """Experimental: This option causes iperf to execute """
            """this flowop at the specified rate for iterations or duration seconds."""
        }
    )# Unit: Default iperf unit
...
class ProfileFlowOpDataCommon(ProfileFlowOpCommon):
    ...
    size: int = field(
        ...
        metadata={
            ...
            """Amount of data that is either read or written. Iperf supports exchange of:\n"""
            """ - Fixed size messages\n"""
    ...
    canfail: bool = field(
        ...
        metadata={
            "name": "canfail",
            "description": """Indicates that a failure for this flowop will not cause iperf to """
    ...
    conn: typing.Optional[int] = field(
        ...
        metadata={
            ...
            """Currently, the name can be any valid integer, however, iperf could take a string in """
...
class ProfileFlowOpSendFileCommon(ProfileFlowOpCommon):
    ...
    size: typing.Optional[int] = field(
        ...
        metadata={
            ...
            """Instead of sending the whole file, iperf will send size sized chunks one at """
...
@dataclass
class IPerfServerError():
    error_code: int
    error: str

@dataclass
class IPerfServerResults():
    pass
...
class IPerfResults:
    ...
    timeseries_data: typing.Dict[int, typing.Dict[int, IPerfRawData]] = field(
        metadata={
            "name": "timeseries_data",
            "description": """Map of the transaction ID to a map of timestamp to IPerfRawData.\n"""
